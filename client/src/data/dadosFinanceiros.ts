...
export const meses: MesData[] = [
  {
    ...
    receitas: [
      ...
      { id: "r2", descricao: "PC", categoria: "PC", valor: 0 },
    ...
    despesas: [
      { id: "d1", descricao: "Cabelo", categoria: "Cuidados", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d2", descricao: "Aluguel", categoria: "Moradia", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d3", descricao: "Cheque Esp.", categoria: "Banco", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d4", descricao: "Mãe", categoria: "Família", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d5", descricao: "Acordo", categoria: "Dívidas", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      ...
      { id: "d8", descricao: "Alim. Semana", categoria: "Alimentação", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      ...
      { id: "d11", descricao: "VT Ida Mon", categoria: "Transporte", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d12", descricao: "VT Volta Mon", categoria: "Transporte", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d13", descricao: "VT Camp", categoria: "Transporte", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
      { id: "d14", descricao: "SOBRA EMP.", categoria: "Outros", valor: 0, gastei: 0, falta: 0, historico_gastos: [] },
